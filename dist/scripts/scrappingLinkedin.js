(() => {
  ...
  // src/utils/waitForElements.js
  var waitForElements = (selector) => new Promise((res, rej) => {
    const intervalId = setInterval(() => {
      if ($(selector)) {
        clearInterval(intervalId);
        res($(selector));
  ...
  async function scrap() {
    ...
    const response = await import_axios.default.get(`https://www.linkedin.com/voyager/api/identity/profiles${profileName}profileContactInfo/`, {
      headers: {
